...
const Masthead: React.FC = () => {
    ...
    return (
        <div ref={refContainer} className="min-h-screen flex flex-col items-center justify-center sticky top-0 -z-10" style={{
            ...
            <div className={`flex-grow-0 pt-10 transition-opacity duration-1000 z-50 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}>
                <img src="/assets/logo.svg" width={128 / 3} height={114 / 3} alt="logo"/>
            </div>
            <div className="p-12 font-bold z-10 text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] text-center flex-1 flex items-center justify-center flex-col">
                <h1 className="mb-6 text-4xl xl:text-5xl">Apeiron</h1>
            ...
            <div className={`flex-grow-0 pb-20 md:pb-10 transition-all duration-1000 ${imageLoaded ? 'opacity-100' : 'opacity-0 -translate-y-10'}`}>
                <Image src="/assets/logo.png" width={250 / 3} height={160 / 3} alt="scroll" onLoad={handleImageLoaded}/>
            </div>
        </div>
    )
}
